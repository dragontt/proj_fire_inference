...
def parse_args(argv):
    parser = argparse.ArgumentParser(description="Constrain k-mers in bZIP family")
...
def main(argv):
    ...
    for kmer in kmersList:
        kmer = kmer.split('\n')[0]
        # bzip core sequence: GTCAT, GCAAT, GTAAT, GTTAC
        dbdSeqList = ['GTCAT', 'ATGAC', 'GCAAT', 'ATTGC', 'GTAAT', 'ATTAC', 'GTAAC', 'GTTAC']
