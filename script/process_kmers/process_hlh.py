...
def parse_args(argv):
    parser = argparse.ArgumentParser(description="Constrain k-mers in basic helix-loop-helix family")
...
def main(argv):
    ...
    for kmer in kmersList:
        kmer = kmer.split('\n')[0]
        # basic hlh core sequence: CANNTG, N[GA]CGTG, CACG[AC]G
        dbdSeqList = ['CAAATG', 'CAACTG', 'CAAGTG', 'CAATTG', 'CACATG', 'CACCTG', 'CACGTG', 'CACTTG', 
        'CAGATG', 'CAGCTG', 'CAGGTG', 'CAGTTG', 'CATATG', 'CATCTG', 'CATGTG', 'CATTTG', 
        'GCGTG', 'ACGTG', 'CACGC', 'CACGT', 'CACGAG', 'CACGCG', 'CTCGTG', 'CGCGTG']
