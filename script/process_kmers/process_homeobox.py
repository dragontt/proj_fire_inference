...
def parse_args(argv):
    parser = argparse.ArgumentParser(description="Constrain k-mers in homeobox family")
...
def main(argv):
    ...
    for kmer in kmersList:
        kmer = kmer.split('\n')[0]
        # homeobox core sequence: ATTA, ATAAAA, TCGTAAA
        dbdSeqList = ['ATTA', 'TAAT', 'ATAAAA', 'TTTTAT', 'TCGTAAA', 'TTTACGA']
