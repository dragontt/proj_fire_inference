...
for file in ~/Documents/GeneData/yeast/ChIP_data_homeobox_fam/new_6mers/*;
do 
...
for file in ~/Documents/GeneData/yeast/ChIP_data_homeobox_fam/new_7mers/*;
do 
	echo "\nPROCESSING FILE: ${file}\n";
...
for file in ~/Documents/GeneData/yeast/ChIP_data_homeobox_fam/new_8mers/*;
do 
	echo "\nPROCESSING FILE: ${file}\n";
